...
// initialization of uart function declaration.
void init_uart(void);

// print character function declaration.
void putch(unsigned char byte);

// print string function declaration.
int puts(const char *s);

// get character function declaration.
unsigned char getch(void);

// get and display character function declaration.
