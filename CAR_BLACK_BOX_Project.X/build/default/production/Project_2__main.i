...
# 2 "<built-in>" 2
# 1 "Project_2__main.c" 2
# 106 "Project_2__main.c"
...
void main(void)
{
    ...
    while(1)
    {
        ...
        if(temp_state != state)
        {
            clcd_print(clear_clcd_line, (0x80 + (0)));
            clcd_print(clear_clcd_line, (0xC0 + (0)));
